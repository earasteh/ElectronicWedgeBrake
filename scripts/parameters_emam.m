...
%% Wedge
Kcal = 6.8e6;  % Caliper's stiffness
Kpad = 100*3.35e7; % Brake pad stiffness
mu_cal = 0.3; % Brake fdriction coef.
Mw = 0.3; % Wedge mass
alpha = 12*pi/180;%12*pi/180; % angle of wedge
